...
******************************** */
        ...
        function checkForNewMessages() {
            // Implement your logic to check for new messages here
            // For demonstration, let's assume there's a variable isNewMessage set to true when there's a new message
            var isNewMessage = true; // Replace this with your actual logic

            if (isNewMessage) {
                window.focus(); // Focus the current window/tab
                // Optionally, you can also scroll to the bottom of the chat window to show the new message
                                                        ...
                                                        <li class="navbar nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item"
                                                                        href="<?php echo e(route('dashboard')); ?>">Home</a>
                                                                </li>
                                                                <li>
    ...
    </div><?php /**PATH G:\Coding\Laravel\reverbChatApp\reverbChatApp\resources\views/livewire/chat-component.blade.php ENDPATH**/ ?>